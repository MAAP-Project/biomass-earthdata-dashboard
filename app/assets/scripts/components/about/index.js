          ...
          <InpageBody>
            <PageConstrainer>
              <Prose>
                    ...
                    <p>
                      A primary purpose of these missions is to provide biomass density maps that can be used in forest carbon estimation and reporting, and forest and land use management for climate mitigation purposes. Currently, national GHG estimation and reporting depends on either National Forest Inventories (NFIs) or other sparse forest plot data. While the IPCC 2017 AFOLU GPG provides guidance on using biomass density maps for country purposes, there are very few concrete country examples because it is only recently that space-based data have become available at the level of detail and quality useful for such purposes. There are, however, different space missions using different sensors and technologies (radar, lidar) and are thus producing different estimates of biomass. Such disparities are a potential source of confusion for users, so it is highly desirable to produce a single most accurate biomass dataset by combining the strengths of the individual sensors. This dataset must have undergone rigorous, consistent and transparent validation if it is to be used with confidence by the policy community. This issue is pressing as the world prepares for the United Nations Framework Convention on Climate Change's first ‘Global Stocktake' (GST); this will take place in 2023, with repetitions every five years. For space-based biomass information to become a key input to future GSTs, it is essential that it be included in the baseline methods established in the 2023 GST.
                    </p>
                    <p>
                      Several current projects are producing continental to global biomass maps. These include ESA's CCI-Biomass global maps at a scale of 100 m for 2010, 2017, 2018, 2020; JPL's global 100 m map for 2020, and a time series of 10 km (global?) biomass maps from 2000-2020; NASA GEDI's 1 km map for 2020 covering latitudes between ~52° N and 52° S; the NASA ICESat-2 30 m boreal map for 2020; and the UK National Centre for Earth Observation (EO) 100 m time series of maps for Africa from 2007 to 2017. Series of biomass change maps are also becoming available.
                    </p>
                    <p>
