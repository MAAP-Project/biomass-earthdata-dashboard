          ...
          <InpageBody>
            <PageConstrainer>
              <Prose>
                ...
                <p>
                  We welcome your feedback to help improve the Dashboard. To do so you can use the feedback option on this website. For an overview of known issues, please consult the Github <a href='https://github.com/NASA-IMPACT/earthdata-dashboard-starter/issues'>issue queue</a>.
                </p>
              </Prose>
              <ContributeCta>
                <Button
                  size='large'
                  element='a'
                  href='https://github.com/NASA-IMPACT/earthdata-simple'
